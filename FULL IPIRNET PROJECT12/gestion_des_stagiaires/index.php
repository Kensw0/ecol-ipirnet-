...
// --- NEW TREND QUERIES ---
$nbStagThisMonth = (int) $pdo->query("SELECT COUNT(*) FROM stagiaires WHERE DATE_FORMAT(date_inscription, '%Y-%m') = '$moisCourant'")->fetchColumn();
...
<div class="dash-layout">
    <div class="dash-main">
            ...
            <div class="stat-card" style="border-top: 3px solid #fbbf24; background: linear-gradient(to bottom, rgba(251, 191, 36, 0.08) 0%, rgba(255,255,255,0.03) 100%);">
                <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                    <div>
                        ...
                        <div class="stat-label">Demandes d'inscription</div>
                    </div>
        ...
        <div class="card" style="margin-bottom:0;">
            <h2 style="margin-bottom:1rem;">Outils rapides</h2>
            <div class="gds-shortcut-row" style="display:flex; flex-wrap:wrap; gap:0.75rem;">
                <a class="btn secondary" href="demandes_inscription.php"><i class="fa-solid fa-clock" style="color:#fbbf24;"></i> Demandes d'inscription</a>
                <a class="btn secondary" href="stagiaires.php"><i class="fa-solid fa-users" style="color:#60a5fa;"></i> Gestion des stagiaires</a>
                <a class="btn secondary" href="moyennes.php"><i class="fa-solid fa-chart-line" style="color:#34d399;"></i> Saisie moyennes</a>
                <a class="btn secondary" href="documents_officiels.php"><i class="fa-solid fa-file-lines" style="color:#e879f9;"></i> Docs officiels</a>
            </div>
        </div>
    </div>
    ...
    <aside class="dash-aside no-print">
        <div class="card" style="border-top: 3px solid #c084fc;">
            ...
            <a class="btn btn-accent" style="width:100%; justify-content:center; margin-bottom:0.75rem;" href="documents_officiels.php"><i class="fa-solid fa-print"></i> Éditer documents</a>
            <a class="btn btn-outline" style="width:100%; justify-content:center;" href="stagiaires.php#liste-stagiaires"><i class="fa-solid fa-user-plus"></i> Saisir stagiaire</a>
        </div>
        
        <?php if ($nbAbsencesNonJustifiees > 0): ?>
        <div class="card" style="border: 1px solid rgba(239,68,68,0.4); background:rgba(239,68,68,0.06); box-shadow: 0 4px 16px rgba(239,68,68,0.1);">
            <div style="display:flex; align-items:center; gap:0.5rem; margin-bottom:0.75rem;">
                <i class="fa-solid fa-circle-exclamation" style="color:#f87171; font-size:1.2rem;"></i>
                <h2 style="color:#fca5a5; margin:0; font-size:0.9rem;">Attention Requise</h2>
            </div>
            <p style="margin:0 0 1rem;font-size:0.85rem;color:#f87171;line-height:1.4;">Vous avez <strong><?= $nbAbsencesNonJustifiees ?></strong> absences non justifiées en attente de régularisation dans le système.</p>
            <a href="alertes.php" class="btn danger" style="width:100%; justify-content:center;">Traiter les alertes</a>
        </div>
        <?php else: ?>
