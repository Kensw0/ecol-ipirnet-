...
<button type="button" class="fab-button" onclick="document.getElementById('modal-absence').style.display='flex'" style="background: #ef4444; box-shadow: 0 10px 25px -5px rgba(239,68,68,0.5);">
