...
<h1 style="text-align:center;">CERTIFICAT DE SCOLARITÉ</h1>
<p>Le Directeur de <strong>Groupe IPIRNET</strong> certifie que l’élève :</p>
<p><strong><?= h((string) $s['nom'] . ' ' . (string) $s['prenom']) ?></strong>, matricule <strong><?= h((string) $s['matricule']) ?></strong>,</p>
<p>est régulièrement inscrit(e) pour l’année scolaire <strong><?= h((string) $s['annee_scolaire']) ?></strong> en classe de <strong><?= h((string) $s['nom_classe']) ?></strong>, filière <strong><?= h((string) $s['nom_filiere']) ?></strong>.</p>
