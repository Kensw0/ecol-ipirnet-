...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    if ($exportTab === 'stagiaires') {
        $headers = ['Numéro inscription','Nom','Prénom','CIN','Email','Téléphone','Classe','Filière','Année','Niveau'];
        $sql = "SELECT s.num_inscri,s.nom,s.prenom,s.cin,s.email,s.telephone,c.nom_classe,f.nom_filiere,c.annee_scolaire,c.niveau
        ...
        $headers = ['Nom','Prénom','N° Inscription','Classe','Total absences','Justifiées','Injustifiées'];
        ...
        $sql = "SELECT s.nom,s.prenom,s.num_inscri,c.nom_classe,
                       COUNT(*) as total_abs, SUM(a.est_justifiee) as just, COUNT(*)-SUM(a.est_justifiee) as injust
        ...
        foreach ($st->fetchAll() as $r)
            $rows[] = [$r['nom'],$r['prenom'],$r['num_inscri'],$r['nom_classe'],$r['total_abs'],$r['just'],$r['injust']];
    }
          ...
          <table class="rpt-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="stagiaires.php?id=<?= /* no id here, use num_inscri search */ 0 ?>" style="color:#e4e4e7;text-decoration:none;font-weight:600;">
