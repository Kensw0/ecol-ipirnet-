...
<head>
    ...
    <title>État des cotisations mensuelles</title>
...
<h1 style="text-align:center;">ÉTAT DES COTISATIONS (PAR MOIS)</h1>
<p><strong><?= h((string) $s['nom'] . ' ' . (string) $s['prenom']) ?></strong> — <?= h((string) $s['matricule']) ?></p>
<p class="muted" style="font-size:0.95rem;">Historique des marquages « payé / non payé » par mois (pas de montants ni d’échéances Merise).</p>
<h2>Mensualités</h2>
<table class="data">
    <tr><th>Mois</th><th>Payé</th><th>Marqué le</th></tr>
