...
// Use annee_scolaire from filter param if not already resolved from classe
...
if ($idFiliere    > 0)     { $where[] = 'f.id_filiere = ?';     $params[] = $idFiliere;   }
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .ls-meta { width: 100%; border-collapse: collapse; margin: 4px 0 12px; font-size: 11.5pt; }
        ...
        .ls-sign { margin: 22px 4px 18px; width: calc(100% - 8px); border-collapse: collapse; }
        .ls-sign th, .ls-sign td { border: 1px solid #111; padding: 12px 14px; vertical-align: top; }
        .ls-sign th {
            font-weight: 400; font-style: italic;
            font-family: "Monotype Corsiva", "Lucida Handwriting", "Brush Script MT", cursive;
            font-size: 1.2rem; color: #0b3b66;
        ...
        /* ===== Footer ===== */
        .cs-footer {
            border-top: 1px solid #111; padding-top: 6px; margin: 18px 6px 0;
            text-align: center; font-size: .82rem; line-height: 1.45;
        }
...
<div class="cs-doc">
    ...
    <table class="ls-meta">
        ...
        <tr>
            ...
            <td colspan="4"><strong><?= $total ?></strong> stagiaire<?= $total > 1 ? 's' : '' ?></td>
        </tr>
    </table>
    ...
    <table class="ls-table">
        <thead>
            <tr>
                <th class="code">N° Inscription</th>
