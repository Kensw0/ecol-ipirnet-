...
<p><?= h((string) $s['nom'] . ' ' . (string) $s['prenom']) ?> — <?= h((string) $s['matricule']) ?> — <?= h((string) $s['nom_classe']) ?> (<?= h((string) $s['annee_scolaire']) ?>)</p>
<table class="data">
...
$gm = $moy->fetchColumn();
?>
<p><strong>Moyenne générale (tous modules, tous contrôles) :</strong> <?= h((string) $gm) ?> / 20</p>
</div>
</body>
</html>
